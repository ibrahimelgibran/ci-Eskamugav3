                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <?php
                            $nama_kelas = $this->db->get_where('data_kelas', ['id' => $user['id_kelas']])->row_array();
                            if (!is_null($nama_kelas) && array_key_exists('nama', $nama_kelas)) {
                                echo '<div class="h5 mb-0 font-weight-bold text-gray-800">' . $nama_kelas['nama'] . '</div>';
                            } else {
                                echo '<div class="h5 mb-0 font-weight-bold text-gray-800">Nama Kelas Tidak Ditemukan</div>';
                            }
                            ?>
                        </div>
                        <div class="col-auto">
