...
class siswa extends CI_Controller
{
    ...
    // Pastikan $cek_karyawan tidak null dan memiliki elemen 'id_peng'
    if (!is_null($cek_karyawan) && array_key_exists('id_peng', $cek_karyawan)) {
      $karyawan = $cek_karyawan['id_peng'];
    } else {
      // Tangani kasus ketika $cek_karyawan null atau tidak memiliki 'id_peng'
      // Anda dapat mengatur $karyawan sebagai nilai default atau memberikan pesan kesalahan.
      $karyawan = null; // Atau sesuaikan dengan logika aplikasi Anda.
    }
